...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/conda-content-trust-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12775&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/conda-content-trust-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `conda-content-trust` can be installed with:

```
conda install conda-content-trust
```

It is possible to list all of the versions of `conda-content-trust` available on your platform with:
